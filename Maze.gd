...
#
#func onDecorateRoom(Rect room):
#	pass
#
## Implementation of the "growing tree" algorithm from here:
## http://www.astrolog.org/labyrnth/algrithm.htm.
#func _growMaze(Vec start):
#	var cells = <Vec>[];
#	var lastDir
#
#	_startRegion()
...
#func _canCarve(Vec pos, Direction direction):
#	# Must end in bounds.
...
#	_currentRegion++
#
#func _carve(Vec pos, [TileType type]):
#	if (type == null):
#		type = Tiles.floor
#	setTile(pos, type)
